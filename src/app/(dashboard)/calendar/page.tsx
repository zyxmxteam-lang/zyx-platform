...
export default function CalendarPage() {
  ...
  const allMonthEvents = calendarEvents.filter(e => {
  ...
  return (
    <div style={{ padding: "0 0 40px" }}>
      <Header
        title="Calendario"
        subtitle="Gestión de campañas, deadlines y eventos del equipo"
      />
          ...
          <div style={{ background: "#111", border: "1px solid #1c1c1c", borderRadius: 12, overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 24px", borderBottom: "1px solid #1c1c1c" }}>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                ...
                <button
                  onClick={() => setCurrent(new Date(2025, 4, 1))}
                    ...
                    {day && (
                      <>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                          ...
                          {events.length > 2 && (
                            <p style={{ fontSize: 9, color: "#444", padding: "1px 4px" }}>+{events.length - 2} más</p>
                          )}
                        </div>
                      </>
                    )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", gap: 6, marginTop: 4 }}>
                        ...
                        <span style={{ fontSize: 10, color: "#444" }}>{new Date(ev.date).getDate()} {MONTHS[new Date(ev.date).getMonth()]}</span>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div style={{ background: "#111", border: "1px solid #1c1c1c", borderRadius: 12, padding: "16px 20px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {[
                  { type: "launch", color: "#22c55e", label: "Lanzamiento" },
                  { type: "review", color: "#3b82f6", label: "Revisión" },
                  { type: "deadline", color: "#f59e0b", label: "Deadline" },
                  { type: "pause", color: "#ef4444", label: "Pausa" },
                  { type: "planning", color: "#22c55e", label: "Planeación" },
                  { type: "event", color: "#a855f7", label: "Evento" },
                ].map(t => (
